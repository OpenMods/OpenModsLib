...
public final class PerspectiveAwareModel implements IModelCustomData {
	...
	public static final PerspectiveAwareModel EMPTY = new PerspectiveAwareModel(Optional.<ResourceLocation> absent(), ImmutableMap.<TransformType, ResourceLocation> of());
	...
	public IBakedModel bake(final IModelState state, final VertexFormat format, final Function<ResourceLocation, TextureAtlasSprite> bakedTextureGetter) {
		final Map<TransformType, IBakedModel> bakedModels = Maps.transformValues(models, new Function<ResourceLocation, IBakedModel>() {
			@Override
			@Nullable
	...
	private static final class PerspectiveAwareBakedModel extends BakedModelAdapter {
		...
		public Pair<? extends IBakedModel, Matrix4f> handlePerspective(TransformType cameraTransformType) {
			...
			return IPerspectiveAwareModel.MapWrapper.handlePerspective(model, cameraTransforms, cameraTransformType);
		}
	}
